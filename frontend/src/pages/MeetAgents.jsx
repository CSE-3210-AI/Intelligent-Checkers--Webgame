  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl mb-12">
        {/* Agent Megha */}
        <div className="cyber-card cyber-agent-card cyber-agent-card--megha rounded-xl p-8 flex flex-col items-center border-2 border-blue-200">
        ...
        {/* Agent Adiba */}
        <div className="cyber-card cyber-agent-card cyber-agent-card--adiba rounded-xl p-8 flex flex-col items-center border-2 border-slate-400">
