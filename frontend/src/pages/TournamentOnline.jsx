  ...
  return (
    <div className="min-h-screen relative flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl mb-12">
        <div
          className={`cyber-card bg-white rounded-xl shadow-lg p-8 flex flex-col items-center border-2 cursor-pointer transition-all duration-200 ${selected === 'megha' ? 'border-blue-600 ring-2 ring-blue-300' : 'border-blue-200 hover:border-blue-400'}`}
        ...
        <div
          className={`cyber-card bg-white rounded-xl shadow-lg p-8 flex flex-col items-center border-2 cursor-pointer transition-all duration-200 ${selected === 'adiba' ? 'border-slate-700 ring-2 ring-slate-400' : 'border-slate-400 hover:border-slate-600'}`}
